...
//         `http://localhost:5000/api/courses/search?query=${value}`
//       );
...
// {!showSidebar && (
//   <nav
//   className={`fixed top-0 h-16 bg-[#111827] border-b border-gray-700 
//   px-3 md:px-6 py-4 flex items-center justify-between 
//   z-50 transition-all duration-200
//   ${showSidebar ? "sm:left-[260px] sm:w-[calc(100%-260px)]" : "left-0 w-full"}
//   `}
//   >
...
//         bg-[#1F2937] z-50 flex flex-col shadow-lg
